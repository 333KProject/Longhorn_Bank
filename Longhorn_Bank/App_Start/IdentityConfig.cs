...
namespace Longhorn_Bank
{
    ...
    public class AppUserManager : UserManager<AppUser>
    {
        ...
        //0TODO:  Change any settings related to your user password rules, etc.
        public static AppUserManager Create(IdentityFactoryOptions<AppUserManager> options, IOwinContext context)
        {
            ...
            {
                //0TODO: If you want to use email as the username, you need to make sure usernames can have @ 
                //and that each person has a unique email
                AllowOnlyAlphanumericUserNames = false,
                RequireUniqueEmail = true
            };

            // 0TODO: Configure validation logic for passwords
